...
export interface PassageData {
    ...
    passage?: string;
    questions: Question[];
    passageSections?: { label: string; text: string }[]; // Passage‑2
    wordBank?: { letter: string; word: string }[];       // Passage‑3
}
...
/* Alt spellings accepted for short‑answer boxes */
...
/* ───────────────── Small render helpers from Mock-1 ───────────────── */
...
/* ───────────────── Passage & Section renderers (header panel only) ───────────────── */
